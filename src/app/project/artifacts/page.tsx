  ...
  return (
    <div className="flex h-screen bg-[linear-gradient(180deg,var(--gradient-page-start)_0%,var(--gradient-page-end)_100%)] text-ink dark:text-[var(--fg)]">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        {/* ============ HEADER ============ */}
        <div className="flex-shrink-0 border-b border-black/[0.06] bg-white/60 px-6 pt-6 pb-5 backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#161616]/80">
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-[22px] font-bold tracking-tight theme-fg">Downloads</h1>
              <p className="mt-1 text-[13px] leading-relaxed theme-muted">
            ...
            <div className="flex items-center gap-2">
              ...
              {sessions.length > 0 ? (
                <select
                  ...
                  className="rounded-lg border border-black/[0.06] bg-white/80 px-2.5 py-1.5 text-[10px] font-semibold theme-fg dark:border-white/[0.08] dark:bg-white/[0.06]"
                >
