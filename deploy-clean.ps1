# CodeCollab Clean Deploy Script
# Run this on the target machine from the CodeCollab folder
# Usage: Right-click -> Run with PowerShell, OR open PowerShell and run: .\deploy-clean.ps1

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  CodeCollab Clean Deploy" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# 1. Kill all CodeCollab processes
Write-Host "[1/5] Killing CodeCollab processes..." -ForegroundColor Yellow
...
if ($still) {
    Write-Host "  WARNING: CodeCollab still running, force killing..." -ForegroundColor Red
...
$installDir = "$env:LOCALAPPDATA\Programs\CodeCollab"
...
$cacheDir = "$env:APPDATA\CodeCollab"
...
if (-not (Test-Path $source)) {
    ...
    Write-Host "  Make sure you're running this from the CodeCollab project folder." -ForegroundColor Red
...
if (Test-Path "$installDir\CodeCollab.exe") {
...
Start-Process "$installDir\CodeCollab.exe"
Write-Host ""
