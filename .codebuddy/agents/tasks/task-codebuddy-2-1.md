# Define a minimal IPC contract for local persistence Task Agent Context
...
## Task Scope
- Task: Define a minimal IPC contract for local persistence
- Subproject: 2) Desktop App Shell (Electron ↔ Next)
- Purpose relative to the project: Status: Not done. This enables saving/loading room data from the renderer safely.
- Owner: desktop-engineer
- Reviewer: build-sheriff
- Due date: 2026-03-31
