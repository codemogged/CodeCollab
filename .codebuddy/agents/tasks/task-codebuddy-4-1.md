# Add GitHub connect UI + token storage (MVP-safe) Task Agent Context
...
## Task Scope
- Task: Add GitHub connect UI + token storage (MVP-safe)
- Subproject: 4) GitHub Connection (One repo per room)
- Purpose relative to the project: Status: Not done. For MVP, prioritize a working flow; document security tradeoffs clearly.
- Owner: github-integrator
- Reviewer: desktop-engineer
- Due date: 2026-04-06
