# Add a single app-level “shell” navigation for desktop Task Agent Context
...
## Task Scope
- Task: Add a single app-level “shell” navigation for desktop
- Subproject: 2) Desktop App Shell (Electron ↔ Next)
- Purpose relative to the project: Status: Not done. Keep UI simple: Home → Workspace/Room.
