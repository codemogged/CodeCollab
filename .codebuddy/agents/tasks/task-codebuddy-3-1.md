# Room model + local storage wiring (create/list/open) Task Agent Context
...
## Task Scope
- Task: Room model + local storage wiring (create/list/open)
- Subproject: 3) Workspace MVP (Rooms + Editor + Local State)
- Purpose relative to the project: Status: Not done. This is the core “project management” MVP slice.
