# Repo picker: link one repo to a room Task Agent Context
...
## Task Scope
- Task: Repo picker: link one repo to a room
- Subproject: 4) GitHub Connection (One repo per room)
- Purpose relative to the project: Status: Not done. Keep it simple: list repos, select one, save selection.
