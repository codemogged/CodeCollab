# Security baseline: lock down preload exposure Task Agent Context
...
## Task Scope
- Task: Security baseline: lock down preload exposure
- Subproject: 2) Desktop App Shell (Electron ↔ Next)
- Purpose relative to the project: Status: Not done. Prevent accidental broad Node access from the renderer.
