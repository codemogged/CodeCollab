# Show basic GitHub data in the room (issues + PR counts) Task Agent Context
...
## Task Scope
- Task: Show basic GitHub data in the room (issues + PR counts)
- Subproject: 4) GitHub Connection (One repo per room)
- Purpose relative to the project: Status: Not done. Minimal visibility: counts + a short list, not full timeline sync.
